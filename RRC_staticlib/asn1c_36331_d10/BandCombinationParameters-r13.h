...
typedef struct BandCombinationParameters_r13 {
	ENUMERATED_t	*differentFallbackSupported_r13	/* OPTIONAL */;
	...
	ENUMERATED_t	*multipleTimingAdvance_r13	/* OPTIONAL */;
	ENUMERATED_t	*simultaneousRx_Tx_r13	/* OPTIONAL */;
	BandInfoEUTRA_t	 bandInfoEUTRA_r13;
	struct BandCombinationParameters_r13__dc_Support_r13 {
		ENUMERATED_t	*asynchronous_r13	/* OPTIONAL */;
