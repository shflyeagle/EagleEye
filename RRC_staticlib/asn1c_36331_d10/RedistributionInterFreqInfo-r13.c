...
static asn_TYPE_member_t asn_MBR_RedistributionInterFreqInfo_r13_1[] = {
...
static int asn_MAP_RedistributionInterFreqInfo_r13_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RedistributionInterFreqInfo_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RedistributionInterFreqInfo_r13_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RedistributionInterFreqInfo_r13_specs_1 = {
