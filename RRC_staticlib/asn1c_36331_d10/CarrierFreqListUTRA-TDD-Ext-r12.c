...
static asn_per_constraints_t asn_PER_type_CarrierFreqListUTRA_TDD_Ext_r12_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_CarrierFreqListUTRA_TDD_Ext_r12_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_CarrierFreqListUTRA_TDD_Ext_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_CarrierFreqListUTRA_TDD_Ext_r12_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_CarrierFreqListUTRA_TDD_Ext_r12 = {
	...
	sizeof(asn_DEF_CarrierFreqListUTRA_TDD_Ext_r12_tags_1)
		/sizeof(asn_DEF_CarrierFreqListUTRA_TDD_Ext_r12_tags_1[0]), /* 1 */
	&asn_PER_type_CarrierFreqListUTRA_TDD_Ext_r12_constr_1,
