...
static asn_TYPE_member_t asn_MBR_NZP_ResourceConfig_r13_1[] = {
...
static ber_tlv_tag_t asn_DEF_NZP_ResourceConfig_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NZP_ResourceConfig_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* resourceConfig-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NZP_ResourceConfig_r13_specs_1 = {
