...
static asn_TYPE_member_t asn_MBR_AS_Config_v10j0_1[] = {
...
static int asn_MAP_AS_Config_v10j0_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_AS_Config_v10j0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_AS_Config_v10j0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* antennaInfoDedicatedPCell-v10i0 */
};
static asn_SEQUENCE_specifics_t asn_SPC_AS_Config_v10j0_specs_1 = {
