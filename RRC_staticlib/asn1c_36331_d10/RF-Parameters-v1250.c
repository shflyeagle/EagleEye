...
static int
freqBandPriorityAdjustment_r12_5_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
freqBandPriorityAdjustment_r12_5_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
freqBandPriorityAdjustment_r12_5_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	freqBandPriorityAdjustment_r12_5_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
freqBandPriorityAdjustment_r12_5_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
freqBandPriorityAdjustment_r12_5_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
freqBandPriorityAdjustment_r12_5_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
freqBandPriorityAdjustment_r12_5_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
freqBandPriorityAdjustment_r12_5_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
freqBandPriorityAdjustment_r12_5_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
freqBandPriorityAdjustment_r12_5_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_freqBandPriorityAdjustment_r12_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_freqBandPriorityAdjustment_r12_value2enum_5[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_freqBandPriorityAdjustment_r12_enum2value_5[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_freqBandPriorityAdjustment_r12_specs_5 = {
...
static ber_tlv_tag_t asn_DEF_freqBandPriorityAdjustment_r12_tags_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_freqBandPriorityAdjustment_r12_5 = {
	...
	"freqBandPriorityAdjustment-r12",
	freqBandPriorityAdjustment_r12_5_free,
	freqBandPriorityAdjustment_r12_5_print,
	freqBandPriorityAdjustment_r12_5_constraint,
	freqBandPriorityAdjustment_r12_5_decode_ber,
	freqBandPriorityAdjustment_r12_5_encode_der,
	freqBandPriorityAdjustment_r12_5_decode_xer,
	freqBandPriorityAdjustment_r12_5_encode_xer,
	freqBandPriorityAdjustment_r12_5_decode_uper,
	freqBandPriorityAdjustment_r12_5_encode_uper,
...
static asn_TYPE_member_t asn_MBR_RF_Parameters_v1250_1[] = {
...
static int asn_MAP_RF_Parameters_v1250_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_RF_Parameters_v1250_tags_1[] = {
