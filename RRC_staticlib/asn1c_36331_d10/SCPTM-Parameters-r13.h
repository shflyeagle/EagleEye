...
typedef struct SCPTM_Parameters_r13 {
	ENUMERATED_t	*scptm_ParallelReception_r13	/* OPTIONAL */;
	ENUMERATED_t	*scptm_SCell_r13	/* OPTIONAL */;
	ENUMERATED_t	*scptm_NonServingCell_r13	/* OPTIONAL */;
	ENUMERATED_t	*scptm_AsyncDC_r13	/* OPTIONAL */;
