...
static asn_TYPE_member_t asn_MBR_SCG_Config_r12_IEs_1[] = {
...
static int asn_MAP_SCG_Config_r12_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_SCG_Config_r12_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SCG_Config_r12_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* scg-RadioConfig-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
static asn_SEQUENCE_specifics_t asn_SPC_SCG_Config_r12_IEs_specs_1 = {
