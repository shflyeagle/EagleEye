...
static int
memb_bandParametersDL_v10i0_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_bandParametersDL_v10i0_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_bandParametersDL_v10i0_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
...
static ber_tlv_tag_t asn_DEF_bandParametersDL_v10i0_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_bandParametersDL_v10i0_2 = {
	...
	&asn_PER_type_bandParametersDL_v10i0_constr_2,
	asn_MBR_bandParametersDL_v10i0_2,
	1,	/* Single element */
	&asn_SPC_bandParametersDL_v10i0_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_BandParameters_v10i0_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v10i0, bandParametersDL_v10i0),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_bandParametersDL_v10i0_2,
		memb_bandParametersDL_v10i0_constraint_1,
		&asn_PER_memb_bandParametersDL_v10i0_constr_2,
		0,
		"bandParametersDL-v10i0"
		},
};
static ber_tlv_tag_t asn_DEF_BandParameters_v10i0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BandParameters_v10i0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* bandParametersDL-v10i0 */
};
static asn_SEQUENCE_specifics_t asn_SPC_BandParameters_v10i0_specs_1 = {
