...
static asn_TYPE_member_t asn_MBR_SCellToAddMod_r10_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct SCellToAddMod_r10, cellIdentification_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SCellToAddMod_r10, radioResourceConfigCommonSCell_r10),
	...
	{ ATF_POINTER, 3, offsetof(struct SCellToAddMod_r10, radioResourceConfigDedicatedSCell_r10),
	...
	{ ATF_POINTER, 2, offsetof(struct SCellToAddMod_r10, dl_CarrierFreq_v1090),
	...
	{ ATF_POINTER, 1, offsetof(struct SCellToAddMod_r10, antennaInfoDedicatedSCell_v10i0),
...
static int asn_MAP_SCellToAddMod_r10_oms_1[] = { 1, 2, 3, 4, 5 };
