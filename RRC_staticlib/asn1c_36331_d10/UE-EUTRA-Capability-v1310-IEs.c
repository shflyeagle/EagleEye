...
static ber_tlv_tag_t asn_DEF_nonCriticalExtension_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (19 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_25 = {
	sizeof(struct UE_EUTRA_Capability_v1310_IEs__nonCriticalExtension),
	offsetof(struct UE_EUTRA_Capability_v1310_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v1310_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UE_EUTRA_Capability_v1310_IEs, mtc_Parameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MTC_Parameters_r13,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"mtc-Parameters-r13"
...
static asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_v1310_IEs_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* mtc-Parameters-r13 */
