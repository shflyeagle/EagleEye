...
typedef enum ReportConfigInterRAT__triggerType__event__eventId_PR {
	...
	ReportConfigInterRAT__triggerType__event__eventId_PR_eventW1,
	ReportConfigInterRAT__triggerType__event__eventId_PR_eventW2,
	ReportConfigInterRAT__triggerType__event__eventId_PR_eventW3
...
typedef struct ReportConfigInterRAT {
			...
			struct ReportConfigInterRAT__triggerType__event {
				struct ReportConfigInterRAT__triggerType__event__eventId {
					...
					union ReportConfigInterRAT__triggerType__event__eventId_u {
						 ...
						 */
						struct ReportConfigInterRAT__triggerType__event__eventId__eventW1 {
							WLAN_RSSI_Range_r13_t	 w1_Threshold_r13;
							
							/* Context for parsing across buffer boundaries */
							asn_struct_ctx_t _asn_ctx;
						} eventW1;
						struct ReportConfigInterRAT__triggerType__event__eventId__eventW2 {
						...
						struct ReportConfigInterRAT__triggerType__event__eventId__eventW3 {
	...
	ENUMERATED_t	*reportQuantityUTRA_FDD_r10	/* OPTIONAL */;
