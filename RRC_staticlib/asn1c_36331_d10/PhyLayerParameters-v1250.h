...
typedef struct PhyLayerParameters_v1250 {
	ENUMERATED_t	*e_HARQ_Pattern_FDD_r12	/* OPTIONAL */;
	ENUMERATED_t	*enhanced_4TxCodebook_r12	/* OPTIONAL */;
	BIT_STRING_t	*tdd_FDD_CA_PCellDuplex_r12	/* OPTIONAL */;
	ENUMERATED_t	*phy_TDD_ReConfig_TDD_PCell_r12	/* OPTIONAL */;
	ENUMERATED_t	*phy_TDD_ReConfig_FDD_PCell_r12	/* OPTIONAL */;
	ENUMERATED_t	*pusch_FeedbackMode_r12	/* OPTIONAL */;
	ENUMERATED_t	*pusch_SRS_PowerControl_SubframeSet_r12	/* OPTIONAL */;
	ENUMERATED_t	*csi_SubframeSet_r12	/* OPTIONAL */;
	ENUMERATED_t	*noResourceRestrictionForTTIBundling_r12	/* OPTIONAL */;
	ENUMERATED_t	*discoverySignalsInDeactSCell_r12	/* OPTIONAL */;
