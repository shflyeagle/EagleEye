...
static int
syncTxPeriodic_r13_15_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_ENUMERATED.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
syncTxPeriodic_r13_15_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_ENUMERATED.free_struct;
	td->print_struct   = asn_DEF_ENUMERATED.print_struct;
	td->check_constraints = asn_DEF_ENUMERATED.check_constraints;
	td->ber_decoder    = asn_DEF_ENUMERATED.ber_decoder;
...
static void
syncTxPeriodic_r13_15_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
syncTxPeriodic_r13_15_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
syncTxPeriodic_r13_15_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
syncTxPeriodic_r13_15_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
syncTxPeriodic_r13_15_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
syncTxPeriodic_r13_15_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
syncTxPeriodic_r13_15_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
syncTxPeriodic_r13_15_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	syncTxPeriodic_r13_15_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_syncTxPeriodic_r13_constr_15 GCC_NOTUSED = {
...
static asn_INTEGER_enum_map_t asn_MAP_syncTxPeriodic_r13_value2enum_15[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_syncTxPeriodic_r13_enum2value_15[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_syncTxPeriodic_r13_specs_15 = {
...
static ber_tlv_tag_t asn_DEF_syncTxPeriodic_r13_tags_15[] = {
...
asn_TYPE_descriptor_t asn_DEF_syncTxPeriodic_r13_15 = {
	"syncTxPeriodic-r13",
	"syncTxPeriodic-r13",
	syncTxPeriodic_r13_15_free,
	syncTxPeriodic_r13_15_print,
	syncTxPeriodic_r13_15_constraint,
	syncTxPeriodic_r13_15_decode_ber,
	syncTxPeriodic_r13_15_encode_der,
	syncTxPeriodic_r13_15_decode_xer,
	syncTxPeriodic_r13_15_encode_xer,
	syncTxPeriodic_r13_15_decode_uper,
	syncTxPeriodic_r13_15_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_syncTxPeriodic_r13_constr_15,
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_SL_SyncConfig_r12_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SL_SyncConfig_r12, txParameters_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12, rxParamsNCell_r12),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12, syncTxPeriodic_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_SL_SyncConfig_r12_oms_1[] = { 3, 4, 5 };
