...
static int
memb_requestedFrequencyBands_r11_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_requestedFrequencyBands_r11_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_requestedFrequencyBands_r11_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
...
static ber_tlv_tag_t asn_DEF_requestedFrequencyBands_r11_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_requestedFrequencyBands_r11_2 = {
	...
	&asn_PER_type_requestedFrequencyBands_r11_constr_2,
	asn_MBR_requestedFrequencyBands_r11_2,
	1,	/* Single element */
	&asn_SPC_requestedFrequencyBands_r11_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_UECapabilityEnquiry_v1180_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UECapabilityEnquiry_v1180_IEs, requestedFrequencyBands_r11),
		...
		memb_requestedFrequencyBands_r11_constraint_1,
		&asn_PER_memb_requestedFrequencyBands_r11_constr_2,
		0,
		"requestedFrequencyBands-r11"
		},
...
static int asn_MAP_UECapabilityEnquiry_v1180_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UECapabilityEnquiry_v1180_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UECapabilityEnquiry_v1180_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* requestedFrequencyBands-r11 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
static asn_SEQUENCE_specifics_t asn_SPC_UECapabilityEnquiry_v1180_IEs_specs_1 = {
