...
static asn_TYPE_member_t asn_MBR_InterFreqCarrierFreqInfo_v10j0_1[] = {
...
static int asn_MAP_InterFreqCarrierFreqInfo_v10j0_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_InterFreqCarrierFreqInfo_v10j0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqCarrierFreqInfo_v10j0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* freqBandInfo-r10 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* multiBandInfoList-v10j0 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqCarrierFreqInfo_v10j0_specs_1 = {
