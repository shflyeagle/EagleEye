...
static asn_INTEGER_enum_map_t asn_MAP_ce_ModeA_r13_value2enum_2[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_ce_ModeA_r13_enum2value_2[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_ce_ModeA_r13_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_ce_ModeA_r13_tags_2[] = {
...
static asn_INTEGER_enum_map_t asn_MAP_ce_ModeB_r13_value2enum_4[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_ce_ModeB_r13_enum2value_4[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_ce_ModeB_r13_specs_4 = {
...
static ber_tlv_tag_t asn_DEF_ce_ModeB_r13_tags_4[] = {
...
static asn_TYPE_member_t asn_MBR_MTC_Parameters_r13_1[] = {
	{ ATF_POINTER, 2, offsetof(struct MTC_Parameters_r13, ce_ModeA_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct MTC_Parameters_r13, ce_ModeB_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_MTC_Parameters_r13_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_MTC_Parameters_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MTC_Parameters_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ce-ModeA-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ce-ModeB-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MTC_Parameters_r13_specs_1 = {
	sizeof(struct MTC_Parameters_r13),
	offsetof(struct MTC_Parameters_r13, _asn_ctx),
	asn_MAP_MTC_Parameters_r13_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_MTC_Parameters_r13_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_MTC_Parameters_r13 = {
	"MTC-Parameters-r13",
	"MTC-Parameters-r13",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_MTC_Parameters_r13_tags_1,
	sizeof(asn_DEF_MTC_Parameters_r13_tags_1)
		/sizeof(asn_DEF_MTC_Parameters_r13_tags_1[0]), /* 1 */
	asn_DEF_MTC_Parameters_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_MTC_Parameters_r13_tags_1)
		/sizeof(asn_DEF_MTC_Parameters_r13_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_MTC_Parameters_r13_1,
	2,	/* Elements count */
	&asn_SPC_MTC_Parameters_r13_specs_1	/* Additional specs */
};
