...
static int
memb_carrierFreqDiscTx_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_discTxResourceReq_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_carrierFreqDiscTx_r13_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (1..8) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_discTxResourceReq_r13_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  1,  63 }	/* (1..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SL_DiscTxResourceReq_r13_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_DiscTxResourceReq_r13, carrierFreqDiscTx_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_carrierFreqDiscTx_r13_constraint_1,
		&asn_PER_memb_carrierFreqDiscTx_r13_constr_2,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_DiscTxResourceReq_r13, discTxResourceReq_r13),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_discTxResourceReq_r13_constraint_1,
		&asn_PER_memb_discTxResourceReq_r13_constr_3,
		0,
		"discTxResourceReq-r13"
		},
};
static int asn_MAP_SL_DiscTxResourceReq_r13_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_SL_DiscTxResourceReq_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SL_DiscTxResourceReq_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* carrierFreqDiscTx-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* discTxResourceReq-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SL_DiscTxResourceReq_r13_specs_1 = {
