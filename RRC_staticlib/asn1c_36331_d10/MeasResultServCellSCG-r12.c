...
static ber_tlv_tag_t asn_DEF_measResultSCell_v1310_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_measResultSCell_v1310_tag2el_8[] = {
...
static int asn_MAP_MeasResultServCellSCG_r12_oms_1[] = { 2, 3 };
