...
static int
memb_ipv4_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_ipv6_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_ipv4_r13_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  32,  32 }	/* (SIZE(32..32)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ipv6_r13_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  128,  128 }	/* (SIZE(128..128)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_IP_Address_r13_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_IP_Address_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct IP_Address_r13, choice.ipv4_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		memb_ipv4_r13_constraint_1,
		&asn_PER_memb_ipv4_r13_constr_2,
		0,
		"ipv4-r13"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct IP_Address_r13, choice.ipv6_r13),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		memb_ipv6_r13_constraint_1,
		&asn_PER_memb_ipv6_r13_constr_3,
		0,
		"ipv6-r13"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_IP_Address_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_IP_Address_r13_constr_1,
