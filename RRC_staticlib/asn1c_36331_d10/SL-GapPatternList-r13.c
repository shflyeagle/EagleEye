...
static asn_per_constraints_t asn_PER_type_SL_GapPatternList_r13_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SL_GapPatternList_r13_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_SL_GapPatternList_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_SL_GapPatternList_r13_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SL_GapPatternList_r13 = {
	...
	sizeof(asn_DEF_SL_GapPatternList_r13_tags_1)
		/sizeof(asn_DEF_SL_GapPatternList_r13_tags_1[0]), /* 1 */
	&asn_PER_type_SL_GapPatternList_r13_constr_1,
