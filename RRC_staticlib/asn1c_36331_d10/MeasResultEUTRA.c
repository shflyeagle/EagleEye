...
static asn_INTEGER_enum_map_t asn_MAP_freqBandIndicatorPriority_r13_value2enum_19[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_freqBandIndicatorPriority_r13_enum2value_19[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_freqBandIndicatorPriority_r13_specs_19 = {
...
static ber_tlv_tag_t asn_DEF_freqBandIndicatorPriority_r13_tags_19[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
...
static int asn_MAP_cgi_Info_v1310_oms_16[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_cgi_Info_v1310_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_cgi_Info_v1310_tag2el_16[] = {
...
static int asn_MAP_measResult_oms_7[] = { 0, 1, 2, 3, 4, 5, 6 };
