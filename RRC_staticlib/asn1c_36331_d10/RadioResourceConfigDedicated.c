...
static asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicated_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigDedicated, rlf_TimersAndConstants_r9),
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigDedicated, measSubframePatternPCell_r10),
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicated, neighCellsCRS_Info_r11),
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicated, naics_Info_r12),
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicated, neighCellsCRS_Info_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated, rlf_TimersAndConstants_r13),
