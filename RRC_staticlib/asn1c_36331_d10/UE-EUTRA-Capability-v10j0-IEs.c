...
static int asn_MAP_UE_EUTRA_Capability_v10j0_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UE_EUTRA_Capability_v10j0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_v10j0_IEs_tag2el_1[] = {
