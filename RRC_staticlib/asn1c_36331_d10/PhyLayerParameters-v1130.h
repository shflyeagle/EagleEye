...
typedef struct PhyLayerParameters_v1130 {
	ENUMERATED_t	*crs_InterfHandl_r11	/* OPTIONAL */;
	ENUMERATED_t	*ePDCCH_r11	/* OPTIONAL */;
	ENUMERATED_t	*multiACK_CSI_Reporting_r11	/* OPTIONAL */;
	ENUMERATED_t	*ss_CCH_InterfHandl_r11	/* OPTIONAL */;
	ENUMERATED_t	*tdd_SpecialSubframe_r11	/* OPTIONAL */;
	ENUMERATED_t	*txDiv_PUCCH1b_ChSelect_r11	/* OPTIONAL */;
	ENUMERATED_t	*ul_CoMP_r11	/* OPTIONAL */;
