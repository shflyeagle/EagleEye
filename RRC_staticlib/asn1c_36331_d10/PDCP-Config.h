...
typedef struct PDCP_Config {
	ENUMERATED_t	*discardTimer	/* OPTIONAL */;
	 ...
	 * possible extensions are below.
	 */
	ENUMERATED_t	*rn_IntegrityProtection_r10	/* OPTIONAL */;
	ENUMERATED_t	*pdcp_SN_Size_v1130	/* OPTIONAL */;
	BOOLEAN_t	*ul_DataSplitDRB_ViaSCG_r12	/* OPTIONAL */;
	ENUMERATED_t	*t_Reordering_r12	/* OPTIONAL */;
	...
	ENUMERATED_t	*pdcp_SN_Size_v1310	/* OPTIONAL */;
	struct PDCP_Config__statusFeedback_r13 {
		...
		union PDCP_Config__statusFeedback_r13_u {
			...
			struct PDCP_Config__statusFeedback_r13__setup {
				ENUMERATED_t	*statusPDU_TypeForPolling_r13	/* OPTIONAL */;
				ENUMERATED_t	*statusPDU_Periodicity_Type1_r13	/* OPTIONAL */;
				ENUMERATED_t	*statusPDU_Periodicity_Type2_r13	/* OPTIONAL */;
				ENUMERATED_t	*statusPDU_Periodicity_Offset_r13	/* OPTIONAL */;
