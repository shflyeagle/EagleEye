...
typedef struct DeltaFList_PUCCH {
	ENUMERATED_t	 deltaF_PUCCH_Format1;
	ENUMERATED_t	 deltaF_PUCCH_Format1b;
	ENUMERATED_t	 deltaF_PUCCH_Format2;
	ENUMERATED_t	 deltaF_PUCCH_Format2a;
	ENUMERATED_t	 deltaF_PUCCH_Format2b;
