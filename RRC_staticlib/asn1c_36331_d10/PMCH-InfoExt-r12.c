...
static asn_TYPE_member_t asn_MBR_PMCH_InfoExt_r12_1[] = {
...
static ber_tlv_tag_t asn_DEF_PMCH_InfoExt_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PMCH_InfoExt_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pmch-Config-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mbms-SessionInfoList-r12 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PMCH_InfoExt_r12_specs_1 = {
