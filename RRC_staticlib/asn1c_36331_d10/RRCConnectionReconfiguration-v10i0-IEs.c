...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_3 = {
	sizeof(struct RRCConnectionReconfiguration_v10i0_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionReconfiguration_v10i0_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_RRCConnectionReconfiguration_v10i0_IEs_1[] = {
...
static int asn_MAP_RRCConnectionReconfiguration_v10i0_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RRCConnectionReconfiguration_v10i0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionReconfiguration_v10i0_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* antennaInfoDedicatedPCell-v10i0 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionReconfiguration_v10i0_IEs_specs_1 = {
