...
typedef struct PhyLayerParameters_v1310 {
	...
	ENUMERATED_t	*crossCarrierScheduling_B5C_r13	/* OPTIONAL */;
	ENUMERATED_t	*fdd_HARQ_TimingTDD_r13	/* OPTIONAL */;
	long	*maxNumberUpdatedCSI_Proc_r13	/* OPTIONAL */;
	ENUMERATED_t	*pucch_Format4_r13	/* OPTIONAL */;
	ENUMERATED_t	*pucch_Format5_r13	/* OPTIONAL */;
	ENUMERATED_t	*pucch_SCell_r13	/* OPTIONAL */;
	ENUMERATED_t	*spatialBundling_HARQ_ACK_r13	/* OPTIONAL */;
	struct PhyLayerParameters_v1310__supportedBlindDecoding_r13 {
		long	*maxNumberDecoding_r13	/* OPTIONAL */;
		ENUMERATED_t	*pdcch_CandidateReductions_r13	/* OPTIONAL */;
		ENUMERATED_t	*skipMonitoringDCI_Format0_1A_r13	/* OPTIONAL */;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *supportedBlindDecoding_r13;
	ENUMERATED_t	*uci_PUSCH_Ext_r13	/* OPTIONAL */;
	ENUMERATED_t	*crs_InterfMitigationTM10_r13	/* OPTIONAL */;
	ENUMERATED_t	*pdsch_CollisionHandling_r13	/* OPTIONAL */;
