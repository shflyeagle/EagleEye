...
typedef struct RACH_ConfigCommon {
	struct RACH_ConfigCommon__preambleInfo {
		ENUMERATED_t	 numberOfRA_Preambles;
		struct RACH_ConfigCommon__preambleInfo__preamblesGroupAConfig {
			ENUMERATED_t	 sizeOfRA_PreamblesGroupA;
			ENUMERATED_t	 messageSizeGroupA;
			ENUMERATED_t	 messagePowerOffsetGroupB;
			/*
	...
	struct RACH_ConfigCommon__ra_SupervisionInfo {
		...
		ENUMERATED_t	 ra_ResponseWindowSize;
		ENUMERATED_t	 mac_ContentionResolutionTimer;
