...
static asn_TYPE_member_t asn_MBR_LogicalChannelConfig_1[] = {
	{ ATF_POINTER, 3, offsetof(struct LogicalChannelConfig, ul_SpecificParameters),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LogicalChannelConfig, logicalChannelSR_Mask_r9),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LogicalChannelConfig, logicalChannelSR_Prohibit_r12),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,	/* Defer constraints checking to the member type */
...
static int asn_MAP_LogicalChannelConfig_oms_1[] = { 0, 1, 2 };
