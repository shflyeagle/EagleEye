...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_CandidateReductions_r13__setup, pdcch_candidateReductionAL1),
		...
		0,
		"pdcch-candidateReductionAL1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_CandidateReductions_r13__setup, pdcch_candidateReductionAL2),
		...
		0,	/* No PER visible constraints */
		0,
		"pdcch-candidateReductionAL2"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_CandidateReductions_r13__setup, pdcch_candidateReductionAL3),
		...
		0,	/* No PER visible constraints */
		0,
		"pdcch-candidateReductionAL3"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_CandidateReductions_r13__setup, pdcch_candidateReductionAL4),
		...
		0,	/* No PER visible constraints */
		0,
		"pdcch-candidateReductionAL4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PDCCH_CandidateReductions_r13__setup, pdcch_candidateReductionAL5),
...
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pdcch-candidateReductionAL1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pdcch-candidateReductionAL2 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* pdcch-candidateReductionAL3 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pdcch-candidateReductionAL4 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* pdcch-candidateReductionAL5 */
};
