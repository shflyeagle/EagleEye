...
static asn_TYPE_member_t asn_MBR_SL_DiscTxConfigScheduled_r13_1[] = {
...
static int asn_MAP_SL_DiscTxConfigScheduled_r13_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_SL_DiscTxConfigScheduled_r13_tags_1[] = {
