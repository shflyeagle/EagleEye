...
static asn_TYPE_member_t asn_MBR_RadioResourceConfigCommonSCell_r10_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct RadioResourceConfigCommonSCell_r10, ul_CarrierFreq_v1090),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct RadioResourceConfigCommonSCell_r10, rach_ConfigCommonSCell_r11),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigCommonSCell_r10, prach_ConfigSCell_r11),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigCommonSCell_r10, tdd_Config_v1130),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigCommonSCell_r10, uplinkPowerControlCommonSCell_v1130),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigCommonSCell_r10, pusch_ConfigCommon_v1270),
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigCommonSCell_r10, pucch_ConfigCommon_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommonSCell_r10, uplinkPowerControlCommonSCell_v1310),
...
static int asn_MAP_RadioResourceConfigCommonSCell_r10_oms_1[] = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
