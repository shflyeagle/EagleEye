...
static asn_TYPE_member_t asn_MBR_FreqPriorityEUTRA_v1310_1[] = {
...
static int asn_MAP_FreqPriorityEUTRA_v1310_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_FreqPriorityEUTRA_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_FreqPriorityEUTRA_v1310_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cellReselectionSubPriority-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_FreqPriorityEUTRA_v1310_specs_1 = {
