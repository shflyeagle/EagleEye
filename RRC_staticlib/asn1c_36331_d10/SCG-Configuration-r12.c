...
static int
memb_scg_Counter_r12_constraint_4(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_scg_Counter_r12_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (0..65535) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_SCG_Configuration_r12_constr_1 GCC_NOTUSED = {
...
static int asn_MAP_scg_ConfigPartMCG_r12_oms_4[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_scg_ConfigPartMCG_r12_tags_4[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_scg_ConfigPartMCG_r12_tag2el_4[] = {
...
static asn_TYPE_member_t asn_MBR_SCG_Configuration_r12_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_SCG_Configuration_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
static asn_CHOICE_specifics_t asn_SPC_SCG_Configuration_r12_specs_1 = {
