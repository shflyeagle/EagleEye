...
typedef struct RF_Parameters_v1310 {
	struct RF_Parameters_v1310__eNB_RequestedParameters_r13 {
		ENUMERATED_t	*reducedIntNonContCombRequested_r13	/* OPTIONAL */;
		long	*requestedCCsDL_r13	/* OPTIONAL */;
		long	*requestedCCsUL_r13	/* OPTIONAL */;
		ENUMERATED_t	*skipFallbackCombRequested_r13	/* OPTIONAL */;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *eNB_RequestedParameters_r13;
	ENUMERATED_t	*maximumCCsRetrieval_r13	/* OPTIONAL */;
	ENUMERATED_t	*skipFallbackCombinations_r13	/* OPTIONAL */;
	ENUMERATED_t	*reducedIntNonContComb_r13	/* OPTIONAL */;
