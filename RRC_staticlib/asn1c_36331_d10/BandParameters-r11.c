...
static asn_INTEGER_enum_map_t asn_MAP_supportedCSI_Proc_r11_value2enum_5[] = {
	{ 0,	2,	"n1" },
	{ 1,	2,	"n3" },
	{ 2,	2,	"n4" }
};
static unsigned int asn_MAP_supportedCSI_Proc_r11_enum2value_5[] = {
	0,	/* n1(0) */
	1,	/* n3(1) */
	2	/* n4(2) */
};
static asn_INTEGER_specifics_t asn_SPC_supportedCSI_Proc_r11_specs_5 = {
...
static ber_tlv_tag_t asn_DEF_supportedCSI_Proc_r11_tags_5[] = {
...
static int asn_MAP_BandParameters_r11_oms_1[] = { 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_BandParameters_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BandParameters_r11_tag2el_1[] = {
