...
typedef struct IDC_Config_r11 {
	ENUMERATED_t	*idc_Indication_r11	/* OPTIONAL */;
	struct IDC_Config_r11__autonomousDenialParameters_r11 {
		ENUMERATED_t	 autonomousDenialSubframes_r11;
		ENUMERATED_t	 autonomousDenialValidity_r11;
	 ...
	 */
	ENUMERATED_t	*idc_Indication_UL_CA_r11	/* OPTIONAL */;
