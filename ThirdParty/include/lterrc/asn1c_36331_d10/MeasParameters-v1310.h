...
typedef struct MeasParameters_v1310 {
	ENUMERATED_t	*rs_SINR_Meas_r13	/* OPTIONAL */;
	ENUMERATED_t	*whiteCellList_r13	/* OPTIONAL */;
	ENUMERATED_t	*extendedMaxObjectId_r13	/* OPTIONAL */;
	ENUMERATED_t	*ul_PDCP_Delay_r13	/* OPTIONAL */;
	ENUMERATED_t	*extendedFreqPriorities_r13	/* OPTIONAL */;
	ENUMERATED_t	*multiBandInfoReport_r13	/* OPTIONAL */;
	ENUMERATED_t	*rssi_AndChannelOccupancyReporting_r13	/* OPTIONAL */;
