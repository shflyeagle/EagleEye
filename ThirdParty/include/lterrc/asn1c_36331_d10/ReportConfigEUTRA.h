...
typedef struct ReportConfigEUTRA {
	...
	ENUMERATED_t	 triggerQuantity;
	ENUMERATED_t	 reportQuantity;
	long	 maxReportCells;
	ReportInterval_t	 reportInterval;
	ENUMERATED_t	 reportAmount;
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
	ENUMERATED_t	*si_RequestForHO_r9	/* OPTIONAL */;
	ENUMERATED_t	*ue_RxTxTimeDiffPeriodical_r9	/* OPTIONAL */;
	ENUMERATED_t	*includeLocationInfo_r10	/* OPTIONAL */;
	ENUMERATED_t	*reportAddNeighMeas_r10	/* OPTIONAL */;
	...
	ENUMERATED_t	*includeMultiBandInfo_r13	/* OPTIONAL */;
...
/* extern asn_TYPE_descriptor_t asn_DEF_si_RequestForHO_r9_52;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_ue_RxTxTimeDiffPeriodical_r9_54;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_includeLocationInfo_r10_56;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_reportAddNeighMeas_r10_58;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_triggerQuantity_v1310_74;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_reportQuantity_v1310_78;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_includeMultiBandInfo_r13_84;	// (Use -fall-defs-global to expose) */
