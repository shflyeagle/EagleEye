...
typedef struct ReportQuantityWLAN_r13 {
	ENUMERATED_t	*bandRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*carrierInfoRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*availableAdmissionCapacityRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*backhaulDL_BandwidthRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*backhaulUL_BandwidthRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*channelUtilizationRequestWLAN_r13	/* OPTIONAL */;
	ENUMERATED_t	*stationCountRequestWLAN_r13	/* OPTIONAL */;
	/*
