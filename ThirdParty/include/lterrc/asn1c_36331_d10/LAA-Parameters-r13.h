...
typedef struct LAA_Parameters_r13 {
	ENUMERATED_t	*crossCarrierSchedulingLAA_DL_r13	/* OPTIONAL */;
	ENUMERATED_t	*csi_RS_DRS_RRM_MeasurementsLAA_r13	/* OPTIONAL */;
	ENUMERATED_t	*downlinkLAA_r13	/* OPTIONAL */;
	ENUMERATED_t	*endingDwPTS_r13	/* OPTIONAL */;
	ENUMERATED_t	*secondSlotStartingPosition_r13	/* OPTIONAL */;
	ENUMERATED_t	*tm9_LAA_r13	/* OPTIONAL */;
	ENUMERATED_t	*tm10_LAA_r13	/* OPTIONAL */;
